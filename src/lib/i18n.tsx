...
export const dict = {
  fr: {
    ...
    notFound: {
      ...
      body: "Le lien est peut-être obsolète, ou la page a été déplacée. Reprenons depuis l'accueil.",
    ...
    contactPage: {
      ...
      assuranceLabel: "Ce que vous pouvez attendre",
      assurances: [
        "Une réponse personnelle sous 48 heures ouvrées.",
        "Un premier échange sans engagement, en français ou en anglais.",
        "Des pistes concrètes avant toute proposition commerciale.",
      ],
  ...
  en: {
    ...
    notFound: {
      ...
      body: "The link may be outdated, or the page has moved. Let's start again from the homepage.",
    ...
    contactPage: {
      ...
      linkedinLabel: "LinkedIn",
      whatsappLabel: "WhatsApp",
      assuranceLabel: "What you can expect",
      assurances: [
        "A personal reply within 48 business hours.",
        "A first conversation with no commitment, in French or English.",
        "Concrete directions before any commercial proposal.",
      ],
      formLabel: "The form",
